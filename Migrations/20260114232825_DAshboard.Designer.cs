...
namespace Waster.Migrations
{
    ...
    [Migration("20260114232825_DAshboard")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Waster.Models.DbModels.DashboardStats", b =>
                {
                    ...
                    b.Property<double>("MealsServedInKG")
                        .HasColumnType("float");

                    b.Property<int>("Monthlygoals")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Waster.Models.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Waster.Models.DbModels.DashboardStats", b =>
                {
                    b.HasOne("Waster.Models.AppUser", "user")
                        .WithOne()
                        .HasForeignKey("Waster.Models.DbModels.DashboardStats", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
